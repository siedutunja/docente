  ...
  <div>
    <b-row class="mt-2">
      <b-col lg="12">
        <b-card>
          <template #header>
            <h5 class="mb-0"><b-icon icon="card-checklist" aria-hidden="true"></b-icon> PLANILLAS AUXILIARES</h5>
          </template>
          <b-card-text>
            <b-row>
              <b-col lg="12">
                          ...
                          <div ref="contenido">
                            <div v-for="(curso, index) in cursosSeleccionados" :key="index" class="bloque-curso">
                              <div class="encabezado">
                                <p>SECRETARÍA DE EDUCACIÓN TERRITORIAL DE TUNJA<br><b>{{$store.state.nombreInstitucion}}</b><br>TUNJA - BOYACÁ<br>PLANILLAS AUXILIARES<br></p>
                              </div>
