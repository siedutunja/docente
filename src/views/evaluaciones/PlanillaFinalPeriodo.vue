  ...
  <div>
    <b-row class="mt-2">
      <b-col lg="12">
        <b-card>
          <template #header>
            <h5 class="mb-0"><b-icon icon="card-checklist" aria-hidden="true"></b-icon> RESUMEN FINAL POR PERIODO</h5>
          </template>
          <b-card-text>
            <b-row>
              <b-col lg="3">
            ...
            <div v-if="planillita == 1">
              <NotasFinalPeriodo :configuracionPlanilla="configuracionPlanilla" @retorno="datosRecibidos"/>
            </div>
            <div v-else-if="planillita == 2">
              <PreeFinalPeriodo :configuracionPlanilla="configuracionPlanilla"/>
            </div>
...
<script>
  ...
  import NotasFinalPeriodo from '@/views/evaluaciones/NotasFinalPeriodo'
  import PreeFinalPeriodo from '@/views/evaluaciones/PreeFinalPeriodo'

  export default {
    name: 'planillafinalperiodo',
    components: {
