      ...
      <b-row class="mt-2">
        <b-col lg="12">
          <h6>Conceptos Valorativos:
            <span class="ml-3 text-danger">NECESITA REFUERZO: (N)</span>
            <span class="ml-3 text-warning">EN PROCESO: (E)</span>
            <span class="ml-3 text-success">ALCANZADO: (A)</span>
...
<script>
  ...
  export default {
    name: 'preeparcialperiodolibertador',
    props: {
    ...
    methods: {
      ...
      actualizarItemPreeC1(item) {
        ...
        if (item.c1 == '' || item.c1 == null) {
          ...
          if (item.c1 == 'N' || item.c1 == 'E' || item.c1 == 'A' || item.c1 == 'R') {
      ...
      actualizarItemPreeC2(item) {
        ...
        if (item.c2 == '' || item.c2 == null) {
          ...
          if (item.c1 == 'N' || item.c2 == 'E' || item.c2 == 'A' || item.c2 == 'R') {
