        ...
        .then(response => {
          if (response.data.error){
            ...
            if (response.data.datos == 0) {
              ...
              this.$store.commit('set', ['recupP1_Ini', response.data.datos.usuario.notasP1_Ini])
              this.$store.commit('set', ['recupP1_Fin', response.data.datos.usuario.notasP1_Fin])
              this.$store.commit('set', ['recupP2_Ini', response.data.datos.usuario.notasP2_Ini])
              this.$store.commit('set', ['recupP2_Fin', response.data.datos.usuario.notasP2_Fin])
              this.$store.commit('set', ['recupP3_Ini', response.data.datos.usuario.notasP3_Ini])
              this.$store.commit('set', ['recupP3_Fin', response.data.datos.usuario.notasP3_Fin])
              this.$store.commit('set', ['recupP4_Ini', response.data.datos.usuario.notasP4_Ini])
              this.$store.commit('set', ['recupP4_Fin', response.data.datos.usuario.notasP4_Fin])
              this.$store.commit('set', ['recupP5_Ini', response.data.datos.usuario.notasP5_Ini])
              this.$store.commit('set', ['recupP5_Fin', response.data.datos.usuario.notasP5_Fin])
